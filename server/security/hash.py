...
class HashGenerator:
    def __init__(self):
        self._hash_ctx_layer_1: CryptContext = CryptContext(schemes=[settings.HASHING_ALGORITHM_LAYER_1], deprecated="auto")
        self._hash_ctx_layer_2: CryptContext = CryptContext(schemes=[settings.HASHING_ALGORITHM_LAYER_2], deprecated="auto")
    ...
    def generate_password_hash(self, hash_salt: str, password: str) -> str:
        ...
        hash, before hash it for the second time using a different hashing
        algorithm."""
